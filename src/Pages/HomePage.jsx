...
const HomePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // const avatarId = avatars.indexOf(selectedAvatar); 
      ...
      // await handleUpdateSubscriberProfile(msisdn, userProfile.nickname, avatarId + 1); 

      setCurrentAvatar(selectedAvatar);

      localStorage.setItem("avatarId", avatarId);
      // localStorage.setItem("avatarId", avatarId + 1); // Store avatarId
